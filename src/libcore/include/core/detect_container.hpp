...
#ifndef _CORE_DETECT_CONTAINER_HPP_
#define _CORE_DETECT_CONTAINER_HPP_

/**
 Detect if the type T has a const_iterator in the compilation step

 @tparam     T     The type which one test if it has a const_iterator
*/
template <typename T>
